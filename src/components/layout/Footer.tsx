...
export function Footer() {
  ...
  return (
    <footer className="bg-bg-secondary text-text-primary mt-[100px]" role="contentinfo">
      {/* Stores + Newsletter */}
      <div
      ...
      >
        ...
        <div className="px-[7.8vw] lg:px-0 lg:w-[37vw]">
          ...
          >
            ...
            <button
              type="submit"
              className="absolute right-0 top-1/2 -translate-y-1/2 border border-border bg-bg-primary px-2 uppercase transition-colors hover:border-accent-gold hover:bg-accent-gold hover:text-text-inverse"
          ...
          <p
            className="mt-8 md:mt-12 text-text-muted max-w-[320px] lg:w-[81%]"
